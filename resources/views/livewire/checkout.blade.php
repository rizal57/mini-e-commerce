                ...
                <div>
                    <div class="p-4 rounded-md shadow-md">
                        ...
                        <div>
                            ...
                            <div>
                                <button wire:click="bayar({{ $subtotal }})" class="w-full bg-teal-500 text-white font-semibold hover:bg-teal-600 transition-all duration-300 rounded-lg py-2 px-4">Bayar</button>
                            </div>
                        </div>
                    </div>
                </div>
