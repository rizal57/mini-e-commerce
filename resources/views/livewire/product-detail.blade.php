        ...
        <div class="ml-8 border rounded-lg p-4">
            <div>
                ...
                <div class="flex gap-2 text-slate-500">
                    ...
                    <div>
                        ...
                        <div>
                            <a href="#" class="text-teal-500 font-semibold text-base">Pilih Kurir</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="mt-4">
                ...
                <div class="flex items-center gap-4 text-base">
                    <div>
                        <input type="number" class="p-2 px-2 border border-slate-300 rounded-md ring-slate-500 focus:ring-teal-400 focus:border-slate-200 h-8 w-20 text-slate-500" value="0">
                    </div>
                    <div>
                ...
                {{-- button --}}
                <div class="mt-6">
                    <button class="bg-teal-500 text-white font-semibold py-2 px-4 rounded-md w-full">+ Keranjang</button>
                </div>
            </div>
        </div>
    </div>
